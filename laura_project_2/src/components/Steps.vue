...
import School from '@/components/Step.vue'
import { schoolData } from '@/staticData/schoolData'
import { professionalData } from '@/staticData/professionalData'
</script>
...
/* Point sur la ligne */
.timeline-vertical > div .timeline-content::before {
  content: '';
  position: absolute;
  top: 2.5rem;
  left: -28px;
