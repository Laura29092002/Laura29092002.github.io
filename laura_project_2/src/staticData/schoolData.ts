...
export const schoolData: schoolStep[] = [
  {
    ...
    period: '2022 - 2025',
    description: "Développement frontend (HTML CSS, React et Vue);Développement backend (Python, Java, PHP);Bases de données (SQL et NoSQL);Méthodologies agiles (Scrum, Kanban)",
